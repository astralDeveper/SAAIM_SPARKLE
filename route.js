...
//Add Stories
const AddStories = require("./server/stories/stories.route");
route.use("/addstories", AddStories);
//Add Stories
const Intrest = require("./server/intrest/intrest.route");
route.use("/findIntrest", Intrest);

//  friend route
const Friend = require("./server/friends/friend.route")
...
// AppUpdte route
const AppUpdate = require("./server/appupdate/appUpdateroute");
route.use("/UpdateApp", AppUpdate);
