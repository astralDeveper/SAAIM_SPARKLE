...
export const USER = {
  ...
  GET_ALL_USER_CHAT: `${BASE_URL}allchatList`,
  ...
  INCOME_FRIENDS: `${BASE_URL}friends/incoming-friend-requests`,
  USER_LIVE: `${BASE_URL}user/live`,
  LIVE_USERS: `${BASE_URL}streams`,
  GOOGLE_PAY: `${BASE_URL}/coinPlan/purchase/googlePlay`,
  GET_ALL_USERS: `${BASE_URL}getUser`,
  ACCEPT_REQUEST: `${BASE_URL}friends/accept-request`,
};
