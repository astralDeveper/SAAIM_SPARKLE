...
exports.store = async (req, res) => {
  try {
    ...
    redeem.accountNumber = req.body.accountNumber;
    redeem.accountName = req.body.accountName;
...
//     return res.status(200).json({ status: true, message: 'Success!!', redeem: JSON.parse(stringify(redeem)) });
//   } catch (error) {
//     console.log(error);
//     return res
//       .status(500)
